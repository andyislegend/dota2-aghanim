...
import com.avenga.steamclient.protobufs.dota.DotaGCMessagesCommon.CMsgDOTAMatch;
...
public class DotaMatchDetailsCallback extends BaseCallbackMessage {
    ...
    public DotaMatchDetailsCallback(CMsgGCMatchDetailsResponse.Builder builder) {
        ...
        this.dotaMatchDetails = DotaMatchDetails.builder()
    ...
    private List<DotaPicksBans> getPickBans(CMsgDOTAMatch match) {
    ...
    private List<DotaMatchDetailsPlayer> getPlayers(CMsgDOTAMatch match) {
    ...
    private List<DotaPlayerAbilityUpgrade> getUpgrades(CMsgDOTAMatch.Player player) {
    ...
    private List<DotaAdditionalUnitInventory> getUnitInventories(CMsgDOTAMatch.Player player) {
    ...
    private List<DotaPlayerPermanentBuff> getPermanentBuffs(CMsgDOTAMatch.Player player) {
    ...
    private List<DotaHeroDamageReceived> getDamageReceivedList(CMsgDOTAMatch.Player player) {
