...
class AsnParser {
    ...
    public byte[] next() throws BerDecodeException {
        ...
        if (length > remainingBytes()) {
            throw new BerDecodeException(String.format("Incorrect Size. Specified: %d, Remaining: %d",
                    length, remainingBytes()), position);
        }
    ...
    public byte getNextOctet() throws BerDecodeException {
        ...
        if (0 == remainingBytes()) {
            throw new BerDecodeException(String.format("Incorrect size. Specified: %d, Remaining: %d", 1,
    ...
    public int nextOctetString() throws BerDecodeException {
        ...
        final int length = getLength();
        if (length > remainingBytes()) {
            throw new BerDecodeException(String.format("Incorrect Octet String Size. Specified: %d, Remaining: %d",
                    length, remainingBytes()), position);
        }
    ...
    public byte[] nextInteger() throws BerDecodeException {
        ...
        final int length = getLength();
        if (length > remainingBytes()) {
            throw new BerDecodeException(String.format("Incorrect Integer Size. Specified: %d, Remaining: %d",
                    length, remainingBytes()), position);
        }
    ...
    public byte[] nextOID() throws BerDecodeException {
        ...
        final int length = getLength();
        if (length > remainingBytes()) {
            throw new BerDecodeException(String.format("Incorrect Object Identifier Size. Specified: %d, Remaining: %d",
                    length, remainingBytes()), position);
        }
